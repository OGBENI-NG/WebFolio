...
import { RiCss3Line, RiHtml5Line, RiJavascriptLine, RiReactjsLine } from 'react-icons/ri'; // Importing icons for HTML, CSS, JavaScript, and React
import { TbBrandTailwind, TbBrandFigma, TbBrandFirebase, TbBrandFramer } from "react-icons/tb"; // Importing icons for Tailwind CSS, Figma, Firebase, and Framer
...
export default function SkillsIcons({ highLightTxtOne, theme, highLightTxt, bodyPadding }) {
  // Define styles for icons based on theme
