          ...
          <div className="relative" key={field.id}>
            {field.type !== 'textarea' ? (
              ...
              <textarea
                ...
                value={formData[field.id]}
                onChange={handleChange}
                className={`${borderStyle} w-full h-[158px] rounded-[8px] outline:none text-lg p-4 peer leading-tight placeholder-transparent resize-none focus:outline-none font-semibold transition-all`}
              />
            )}
